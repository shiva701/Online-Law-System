        ...
        <div class="container-fluid"> <%-- start of conatiner--%>
            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <h2 id="userhead">Remove Lawyer</h2>
                    <div id="firform">
                        <form action="removelawyer" method="post" class="form-horizontal" >
                            <div class="form-group">
                                <label class="control-label col-sm-2" for="lid">Lawyer ID</label>
                                <div class="col-sm-10">
                                    <input style="margin-left: 10px;" type="text" class="form-control" id="lid"
                ...
                <div class="col-sm-6">
                    ...
                    <center> <img src="images/nolawyer.jpg" class="img-rounded img-responsive"  width="500" style="margin-top: 6%;"></center>
                </div>
